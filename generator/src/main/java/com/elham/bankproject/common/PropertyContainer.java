...
public class PropertyContainer {
    ...
    public PropertyContainer(Environment environment) {
        ...
        this.customerCount = environment.getProperty("customergenerator.customerCount");
        ...
        this.transactionGeneratorMaxBound = environment.getProperty("transactiongenerator.transaction.max");
        this.transactionGeneratorMinBound = environment.getProperty("transactiongenerator.transaction.min");
        this.transactionGeneratorLimit = environment.getProperty("transactiongenerator.transaction.limit");
